...
class html_writer {
    ...
    public static function droplist(array $options, $name, $selected = '', $nothing = array('' => 'choosedots'), array $attributes = null) {
        ...
        $result = self::tag('button',"Choose",['class' =>"btn btn-default dropdown-toggle",'data-toggle'=>"dropdown", 'aria-haspopup'=>"true", 'aria-expanded'=>"false",'style'=>'margin:0 auto 0.5em auto; height:100%']);
