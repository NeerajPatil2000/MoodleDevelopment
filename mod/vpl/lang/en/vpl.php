...
$string ['duedatevalidation'] = 'Due date cannot be earlier than the start date.';
...
$string ['nooverridedata'] = 'You must override at least one of the vpl settings.';
...
$string ['reverttodefaults'] = 'Revert to vpl defaults';
$string ['run'] = 'Run';
